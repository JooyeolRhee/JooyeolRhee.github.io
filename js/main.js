...
(function () {
  ...
  var KO = {
    ...
    'mission.eyebrow': '미션',
    'mission.title': '모든 축에서 흔들림 없는 정밀함.',
    ...
    'research.lede': 'AXIS는 초저전력·고정밀 센서 인터페이스, 전력관리·에너지 하베스팅, 데이터 컨버터, 인-센서/엣지 컴퓨팅을 위한 혼성신호 집적회로를 연구합니다. 우리의 미션은 모든 축에서의 정밀함입니다 — 시간과 온도에도 유지되는 정확도, 시스템 수준의 에너지 효율, 그리고 실환경에서의 강건성.',
    'focus.label': '핵심 주제',
