...
(function () {
  ...
  var KO = {
    ...
    'mission.body': 'AXIS는 정밀 아날로그 프런트엔드부터 고해상도 데이터 컨버터, 전력관리 IC, AI 시스템을 위한 회로까지 폭넓은 집적회로와 시스템을 설계합니다. 연구실 이름의 X는 변수입니다. 응용은 계속 달라지지만 기준은 달라지지 않습니다 — 정확도, 에너지 효율, 소형화, 그리고 현장 강건성.',
